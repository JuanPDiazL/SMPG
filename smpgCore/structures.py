...
class Place:
    ...
    def __init__(self, place_id: str, timeseries: pd.Series, parent: Dataset) -> None:
        ...
        self.seasonal_general_stats = pd.Series({
            ...
            'Total up to Current Period/LTA Pct.': (current_cumsum_mon.iloc[-1]/clim_avg_upto_current)*100,
        ...
        self.selected_seasons_general_stats = pd.Series({
            ...
            'Total up to Current Period/LTA Pct.': (current_cumsum_mon.iloc[-1]/selected_avg_upto_current)*100,
        ...
        self.place_general_stats = pd.Series({
            ...
            'Current Period/Avg Pct.': (current_season.iloc[-1] / climatology_avg.iloc[current_index])*100,
