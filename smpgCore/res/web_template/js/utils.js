...
const categories = {
    ...
    'Start of Season of Current Season': {
        'No Start': { 'color': '#FFF77D', 'function': (x) => x === null },
        '≤Feb-1': { 'color': '#6E00C9', 'function': (x) => x <= 3 },
        'Feb-2': { 'color': '#BF4FE0', 'function': (x) => x === 4 },
        'Feb-3': { 'color': '#E3ADF5', 'function': (x) => x === 5 },
        'Mar-1': { 'color': '#0094AD', 'function': (x) => x === 6 },
        'Mar-2': { 'color': '#21D6FF', 'function': (x) => x === 7 },
        'Mar-3': { 'color': '#8CF2FF', 'function': (x) => x === 8 },
        'Apr-1': { 'color': '#00BD2E', 'function': (x) => x === 9 },
        'Apr-2': { 'color': '#A1FF96', 'function': (x) => x === 10 },
        'Apr-3': { 'color': '#A3FFCC', 'function': (x) => x === 11 },
        'May-1': { 'color': '#F07500', 'function': (x) => x === 12 },
        'May-2': { 'color': '#FF9126', 'function': (x) => x === 13 },
        'May-3': { 'color': '#FFB8AB', 'function': (x) => x === 14 },
        'Jun-1': { 'color': '#004DA8', 'function': (x) => x === 15 },
        'Jun-2': { 'color': '#005CE6', 'function': (x) => x === 16 },
        'Jun-3': { 'color': '#0070FF', 'function': (x) => x === 17 },
        'Jul-1': { 'color': '#F7E8CC', 'function': (x) => x === 18 },
        'Jul-2': { 'color': '#E6C996', 'function': (x) => x === 19 },
        'Jul-3': { 'color': '#CFA836', 'function': (x) => x === 20 },
        '≥Aug-1': { 'color': '#966300', 'function': (x) => x >= 21 },
    },
    'Start of Season Anomaly': {
        'Yet to Start': { 'color': '#FFF77D', 'function': (x) => x === null },
        '≥4 Dk. Early': { 'color': '#004280', 'function': (x) => x <= -4 },
        '3 Dk. Early': { 'color': '#0073F0', 'function': (x) => x === -3 },
        '2 Dk. Early': { 'color': '#008FF5', 'function': (x) => x === -2 },
        '1 Dk. Early': { 'color': '#00A6F5', 'function': (x) => x === -1 },
        'Average': { 'color': '#CCCCCC', 'function': (x) => x === 0 },
        '1 Dk. Late': { 'color': '#FFD4E6', 'function': (x) => x === 1 },
        '2 Dk. Late': { 'color': '#FFC78F', 'function': (x) => x === 2 },
        '3 Dk. Late': { 'color': '#FF734A', 'function': (x) => x === 3 },
        '≥4 Dk. Late': { 'color': '#BA0070', 'function': (x) => x >= 4 },
    },
};
