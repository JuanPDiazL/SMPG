...
def generate_layers_from_csv(map_layer: QgsVectorLayer, join_field: str, selected_stats: list[str], data_path_relation: dict, dataset_properties: Properties):
    ...
    attribute_style_relation = {
        ...
        'Forecast 3rd Period Pct. of Avg.': {'classes': 'anomaly_percent', 'data': 'general_stats'},
        'Forecast Accumulation Pct. of Avg.': {'classes': 'anomaly_percent', 'data': 'general_stats'},
        'Total up to Current Period Pct. of Avg.': {'classes': 'anomaly_percent', 'data': 'climatology_stats'},
        'Total up to Forecast Pct. of Avg.': {'classes': 'anomaly_percent', 'data': 'climatology_stats'},
        'Ensemble Med. Pct. of Avg.': {'classes': 'anomaly_percent', 'data': 'selected_years_stats'},
        'Ensemble Med. w Forecast Pct. of Avg.': {'classes': 'anomaly_percent', 'data': 'selected_years_stats'},
        'Probability Below Normal': {'classes': 'prob_below_normal', 'data': 'selected_years_stats'},
        'Probability Below Normal w. Forecast': {'classes': 'prob_below_normal', 'data': 'selected_years_stats'},
        'Probability of Normal': {'classes': 'prob_above_normal', 'data': 'selected_years_stats'},
        'Probability of Normal w. Forecast': {'classes': 'prob_above_normal', 'data': 'selected_years_stats'},
        'Probability Above Normal': {'classes': 'prob_above_normal', 'data': 'selected_years_stats'},
        'Probability Above Normal w. Forecast': {'classes': 'prob_above_normal', 'data': 'selected_years_stats'},
